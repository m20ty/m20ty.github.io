...
## Dartmoor Circular Walk

This is a map of a circular walk in Dartmoor National Park, UK.  It starts and ends in the village of Postbridge, and takes the hiker across open moorland, taking in some interesting features and peaks.

Click on the markers for the name of each point along the route, along with some extra details.  Click on the lines connecting the markers for information about that leg of the route, particularly terrain.
